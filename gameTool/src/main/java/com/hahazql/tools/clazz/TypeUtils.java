...
import com.hahazql.tools.format.Base64;
...
public class TypeUtils {
    ...
    public static final Byte castToByte(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Character castToChar(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Short castToShort(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Float castToFloat(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Double castToDouble(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Date castToDate(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final java.sql.Date castToSqlDate(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final java.sql.Timestamp castToTimestamp(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Long castToLong(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final Integer castToInt(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final byte[] castToBytes(Object value) throws BaseException {
    ...
    public static final Boolean castToBoolean(Object value) throws BaseException {
        if (value == null) {
            return null;
        }
    ...
    public static final <T> T castToJavaBean(Object obj, Class<T> clazz) throws BaseException {
        return cast(obj, clazz, ParserConfig.getGlobalInstance());
    }

    @SuppressWarnings({"unchecked", "rawtypes"})
    public static final <T> T cast(Object obj, Class<T> clazz, ParserConfig mapping) throws BaseException {
        if (obj == null) {
            return null;
        }

        if (clazz == null) {
            throw new IllegalArgumentException("com.hahazql.util.clazz is null");
        }
        ...
        // if (com.hahazql.util.clazz == char.class || com.hahazql.util.clazz == Character.class) {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static final <T> T castToEnum(Object obj, Class<T> clazz, ParserConfig mapping) throws BaseException {
        try {
            if (obj instanceof String) {
    ...
    public static final <T> T cast(Object obj, Type type, ParserConfig mapping) throws BaseException {
        if (obj == null) {
            return null;
        }
        ...
        throw new BaseException("can not cast to : " + type);
    }

    @SuppressWarnings({"rawtypes", "unchecked"})
    public static final <T> T cast(Object obj, ParameterizedType type, ParserConfig mapping) throws BaseException {
    ...
    @SuppressWarnings({"unchecked"})
    public static final <T> T castToJavaBean(Map<String, Object> map, Class<T> clazz, ParserConfig mapping) throws BaseException {
        try {
