...
public class ConcurrentLinkedHashMap<K, V> implements Map<K, V> {
     ...
     * At the same com.hahazql.util.time, this method will call the callback interface, the getting entry com.hahazql.util.event will be triggered.
     *
     ...
     * This method will call the putting entry com.hahazql.util.event when the method is called.
     *
    ...
    /**
     * Remove a entry from this map. The removing com.hahazql.util.event will be called.
     *
