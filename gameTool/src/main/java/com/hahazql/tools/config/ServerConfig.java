...
public abstract class ServerConfig implements Config {
     ...
     * 取得资源文件的绝对路径
     *
     * @param pathes 路径的参数,每个参数将使用路径分隔符连接起来
     * @return
     */
    ...
    /**
     * @param localHostId the localHostId to set
     */
    ...
    /**
     * @param serverGroupId the serverGroupId to set
     */
    ...
    /**
     * @param serverIndexId the serverIndexId to set
     */
    ...
    /**
     * @param ioProcessor the ioProcessor to set
     */
    ...
    /**
     * @param localDomain the localDomain to set
     */
